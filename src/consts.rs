...
// BULLET
lazy_static! {
    pub static ref BULLET_COLLIDER_HALF_SIZE: Vector3 =
        Vector3::new_from_array([[1.0], [1.0], [1.0]]);
...
// Starship
lazy_static! {
    pub static ref STARSHIP_BULLET_VELOCITY: Vector3 =
        Vector3::new_from_array([[5.0], [0.0], [0.0]]);
}
...
lazy_static! {
    pub static ref NONDESCRIPTCIRCLE_COLLIDER_HALF_SIZE: Vector3 =
        Vector3::new_from_array([[1.0], [1.0], [1.0]]);
    pub static ref NONDESCRIPTCIRCLE_SCALE: Vector3 =
        Vector3::new_from_array([[10.0], [10.0], [10.0]]);
    pub static ref NONDESCRIPTCIRCLE_SPEED: Vector3 =
        Vector3::new_from_array([[0.05], [0.05], [0.05]]);
    pub static ref NONDESCRIPTCIRCLE_MIN_SCALE: Vector3 =
        Vector3::new_from_array([[4.0], [4.0], [4.0]]);
    pub static ref NONDESCRIPTCIRCLE_MAX_SCALE: Vector3 =
        Vector3::new_from_array([[10.0], [10.0], [10.0]]);
}
...
lazy_static! {
    pub static ref WORLD_BOUNDING_BOX: AABB = AABB {
        ...
        half_size: Vector3::new_from_array([[2500.0], [2500.0], [2500.0]])
    };
}
